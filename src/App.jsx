...
const projectData = {
  ru: {
    ...
    intro: "Parki ar minda (в переводе с грузинского «Пакет не нужен») — экологическая организация, которая с 2020 года помогает жителям Тбилиси сортировать отходы.\n\nЗа 2025 год команде Parki ar minda удалось привлечь к сортировке 25 000 тбилисцев и собрать 115 тонн пластика, стекла и картона. С организацией сотрудничают 65 волонтёров: они принимают и сортируют отходы в трёх точках города — в районах Ваке, Сабуртало и Чугурети.\n\nЯ живу в Тбилиси с 2022 года, но об организации услышала раньше — от подруги, которая волонтёрит в Parki ar minda почти 6 лет. Узнавая о её опыте волонтёрства и знакомясь с другими участницами и участниками организации, я нашла вдохновение в сообществах и практиках, которые действуют вопреки экологической тревоге.",
    photos: [
  ...
  en: {
    title: "Parki ar minda",
    intro: "Parki ar minda (“No bag needed” in Georgian) is an environmental organization that has been helping Tbilisi residents sort their waste since 2020.\n\nIn 2025, the Parki ar minda team engaged 25,000 Tbilisi residents in waste sorting and collected 115 tons of plastic, glass, and cardboard. The organization works with 65 volunteers who collect and sort waste at three locations across the city — in the Vake, Saburtalo, and Chugureti districts.\n\nI have lived in Tbilisi since 2022, but I first heard about the organization earlier from a friend who has volunteered with Parki ar minda for almost six years. Learning about her experience and meeting other members of the organization, I found inspiration in communities and practices that choose to act despite eco-anxiety.",
    photos: [
