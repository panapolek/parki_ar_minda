...
const projectData = {
  ru: {
    ...
    photos: [
      ...
      { id: 9, src: photo9, caption: 'Чаще всего приносят стекло — в 2025 году собрали 63,8 тонны' },
  ...
  en: {
    ...
    photos: [
      ...
      { id: 9, src: photo9, caption: 'Glass is brought most often — 63.8 tons were collected in 2025' },
